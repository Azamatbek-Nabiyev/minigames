...
export const carouselGames: GameCard[] = [
  { id: 'islanders', title: 'ISLANDERS: New Shores', likes: '54.2K', rating: 4.9, image: islandersImage },
  { id: 'vacation-cafe', title: 'Vacation Cafe Simulator', likes: '28.7K', rating: 4.8, image: vacationCafeImage },
  { id: 'winter-burrow', title: 'Winter Burrow', likes: '32.4K', rating: 4.9, image: winterBurrowImage },
  { id: 'shelve-potions', title: 'Shelve the Potions!', likes: '21.3K', rating: 4.7, image: shelvePotionsImage },
